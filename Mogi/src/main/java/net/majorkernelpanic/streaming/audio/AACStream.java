 ...
 * You should use a {@link android.service.textservice.SpellCheckerService.Session} instantiated with {@link net.majorkernelpanic.streaming.SessionBuilder} instead of using this class directly.
 * Call {@link #setDestinationAddress(java.net.InetAddress)}, {@link #setDestinationPorts(int)} and {@link #setAudioQuality(net.majorkernelpanic.streaming.audio.AudioQuality)}
