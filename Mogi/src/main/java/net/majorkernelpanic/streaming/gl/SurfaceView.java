 ...
 * libstreaming, call {@link net.majorkernelpanic.streaming.MediaStream#setStreamingMethod(byte)}
 * with {@link net.majorkernelpanic.streaming.MediaStream#MODE_MEDIACODEC_API_2}. <br />
 * <p/>
...
public class SurfaceView extends android.view.SurfaceView implements Runnable, OnFrameAvailableListener, SurfaceHolder.Callback {
     ...
     * the {@link net.majorkernelpanic.streaming.video.VideoStream} will do it when it's needed.
     */
